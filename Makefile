...
PROJECT_NAME = corruptmnist_cookiecutter
PYTHON_VERSION = 3.11
...
data:
	python $(PROJECT_NAME)/data/make_dataset.py --raw_dir=data/raw/$(PROJECT_NAME) --processed_dir=data/processed/$(PROJECT_NAME)
